---
task_id: hydrate-project-ontology-and-register-active-artifacts
title: Hydrate project ontology and register active artifacts
status: done
assigned_role: data
dependencies: []
acceptance_criteria:
- the hydration pipeline executes for this project and produces ontology artifacts
  on disk
...
- research_plan
- artifacts
latest_run_summary: Completed by the local rail verification path. The project now
  registers active artifacts, source records, claims, lineage, and verification runs
  through ResearchIntegrityRepo.
runner: codex_cli
---
